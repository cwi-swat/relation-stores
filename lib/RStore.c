...
/*{{{  RS_RElem RS_visitRElem(RS_RElem arg, int (*acceptIntValue)(int), char* (*acceptStrValue)(char*), RS_Location (*acceptLocation)(RS_Location), RS_RElemList (*acceptList)(RS_RElemList)) */
